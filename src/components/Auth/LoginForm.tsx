    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">SITS Portal</h1>
          <p className="text-blue-200">Sinhgad Institute of Technology</p>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p><strong>Admin:</strong> admin@sits.edu.in / admin123</p>
              <p><strong>Student:</strong> student@sits.edu.in / student123</p>
            </div>
          </div>
        </div>
      </div>
